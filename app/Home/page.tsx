...
>
 ...
 <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t mt-4 from-white via-white/10 to-transparent backdrop-blur-[1px]"></div> 
      ...
      <div className="space-y-4">
       ...
       <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-50">
         <div className=" px-4 md:px-6">
           ...
           <div className=" w-full  grid grid-cols-1 sm:grid-cols-2  sm:grid-cols-3   gap-6 mt-8">
       {loading ? (
